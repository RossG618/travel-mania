// import { faFacebook, fatwitter, faInstagram } from '@fortawesome/free-solid-svg-icons/import.macro';

export default function Footer() {
    return(
<div className="container bg-body rounded shadow-sm">
  <footer className="d-flex flex-wrap justify-content-between  py-3 border-top">
    ...
    <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
      <li className="ms-3"><a className="text-muted" href="https://en-gb.facebook.com/">
      ...
      <li className="ms-3"><a className="text-muted" href="https://twitter.com/?lang=en">
